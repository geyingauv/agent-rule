...
**最后更新：** 2025-10-30  
**适用范围：**  
- 所有由 AI（Agent / LLM）参与的**后端系统开发项目**  
- 包含代码生成、代码修改、接口文档、配置文件、日志生成等任务  

**目标：**  
建立一套通用的 AI 开发协作约束，确保生成内容 **可控、可信、可追溯、可维护**。
...
- 任何生成或修改均需与项目中的「唯一可信源（Source of Truth）」保持一致：  
  - 数据模型 / 实体定义  
  - 接口协议  
  - 配置结构  
  - 约定式命名或规范文档  
...
- 函数、模块、接口的输入输出需与数据模型一致；
- 不可直接修改其他模块的逻辑；
- 当发现潜在风险（如命名冲突或重复实现）时，应提示开发者。
